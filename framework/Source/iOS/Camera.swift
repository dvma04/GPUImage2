...
public class Camera: NSObject, ImageSource, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate {
	...
	let cameraProcessingQueue = DispatchQueue.global(priority: .default)
	let audioProcessingQueue = DispatchQueue.global(priority: .default)
	let metadataProcessingQueue = DispatchQueue(label: "com.GPUImage.metadata")
